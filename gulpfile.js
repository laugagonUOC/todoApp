...
gulp.task('scripts', function() {
    ...
    ]).pipe(gulp.dest('dist/vendor/bootstrap/fonts'));gulp.src([
        'src/vendor/storejs/*'
    ]).pipe(gulp.dest('dist/vendor/storejs'));
    gulp.src([
 ...
 */
gulp.task('serve', ['html', 'imagemin', 'css','scripts','data','typescript','js'], function() {
    browserSync.init({
        logLevel: "info",
        // browser: ["chrome"],
        port: "3008",
